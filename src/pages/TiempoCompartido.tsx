...
export default function TiempoCompartido() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <section
        className="relative min-h-[50vh] sm:min-h-[55vh] flex items-end pt-32 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden bg-cover bg-center bg-no-repeat text-white"
